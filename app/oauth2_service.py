...
class OAuth2TokenManager:
    ...
    def store_token(
        ...
        existing_token = db.query(OAuth2Token).filter(
            and_(
        ...
        if existing_token:
            ...
            if token_data.refresh_token:
                existing_token.refresh_token = self._encrypt_token(token_data.refresh_token)
            ...
            new_token = OAuth2Token(
                ...
                refresh_token=self._encrypt_token(token_data.refresh_token) if token_data.refresh_token else None,
    ...
    def get_user_tokens(
        ...
        if active_only:
            query = query.filter(OAuth2Token.is_active == True)
    ...
    def cleanup_expired_tokens(self, db: Session) -> int:
        ...
        expired_tokens = db.query(OAuth2Token).filter(
            and_(
...
OAUTH2_SCOPES = {
    ...
    "full": {
        ...
        "permissions": ["read:user", "read:profile", "read:email", "write:user", "write:profile"]
    }
}
